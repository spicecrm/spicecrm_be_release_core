...
class SugarDateTime extends DateTime
{
     ...
     * @return SugarDateTime
     */
    public function setTime($hour, $minute, $sec = 0, $microseconds = NULL)
    {
        if ( phpversion() > 7 ) parent::setTime($hour, $minute, $sec, $microseconds);
        else parent::setTime($hour, $minute, $sec);
        return $this;
    }
