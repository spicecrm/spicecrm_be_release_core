...
class SubPanelTilesTabs extends SubPanelTiles
{
    ...
    function getSubpanelGroupLayout($selectedGroup, $module = '')
    {
        global $current_user;


        $layoutParams = $module ?: $this->module;
    ...
    function applyUserCustomLayoutToTabs($tabs, $key='All', $module = '')
    {
        //WDong Bug: 12258 "All" tab in the middle of a record's detail view is not localized.
        if($key=='All')
    	{
        ...
        $usersCustomLayout = SubPanelTilesTabs::getSubpanelGroupLayout($key, $module);
