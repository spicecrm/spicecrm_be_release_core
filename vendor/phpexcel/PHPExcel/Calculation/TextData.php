...
class PHPExcel_Calculation_TextData {
	...
	private static function _uniord($c) {
	    $cChars = str_split($c, 1);
	    
		if (ord($cChars[0]) >=0 && ord($cChars[0]) <= 127)
			return ord($cChars[0]);
		if (ord($cChars[0]) >= 192 && ord($cChars[0]) <= 223)
			return (ord($cChars[0])-192)*64 + (ord($cChars[1])-128);
		if (ord($cChars[0]) >= 224 && ord($cChars[0]) <= 239)
			return (ord($cChars[0])-224)*4096 + (ord($cChars[1])-128)*64 + (ord($cChars[2])-128);
		if (ord($cChars[0]) >= 240 && ord($cChars[0]) <= 247)
			return (ord($cChars[0])-240)*262144 + (ord($cChars[1])-128)*4096 + (ord($cChars[2])-128)*64 + (ord($cChars[3])-128);
		if (ord($cChars[0]) >= 248 && ord($cChars[0]) <= 251)
			return (ord($cChars[0])-248)*16777216 + (ord($cChars[1])-128)*262144 + (ord($cChars[2])-128)*4096 + (ord($cChars[3])-128)*64 + (ord($cChars[4])-128);
		if (ord($cChars[0]) >= 252 && ord($cChars[0]) <= 253)
			return (ord($cChars[0])-252)*1073741824 + (ord($cChars[1])-128)*16777216 + (ord($cChars[2])-128)*262144 + (ord($cChars[3])-128)*4096 + (ord($cChars[4])-128)*64 + (ord($c{5})-128);
		if (ord($cChars[0]) >= 254 && ord($cChars[0]) <= 255) //error
