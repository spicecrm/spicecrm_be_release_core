...
<table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
	...
	{$mod_strings['LBL_DBCONF_TITLE']}<br>
	<a href="http://www.spicecrm.io" target="_blank">
		<IMG width="300" src="include/images/spice_big.png" alt="SpiceCRM" border="0"></a>
        </th>
</tr>
<tr>
	<td>
...
<hr>
     ...
     <table cellspacing="0" cellpadding="0" border="0" class="stdTable">
        <tr>
            <td>
                <input class="button paper-button-0" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="button" name="goto" value="{$mod_strings['LBL_BACK']}" id="button_back_dbConfig" onclick="document.getElementById('form').submit();" />
            </td>
            <td>
                <input class="button paper-button-0 next" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="button" name="goto" id="button_next2" value="{$mod_strings['LBL_NEXT']}" onClick="callDBCheck();"/>
            </td>
        </tr>
     </table>
</td>
        ...
        if(yes_no == true){
          ...
          <div id='sysCheckMsg' style="display:none">
           <table cellspacing="0" cellpadding="0" border="0" >
               ...
               <tr><td align='center'>
                    <input id='accept_btn' type='button' class="button paper-button-0 next" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" onclick='confirm_drop_tables(true)' value="{$mod_strings['LBL_ACCEPT']}">
                    <input type='button' class="button paper-button-0" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" onclick='confirm_drop_tables(false);' id="button_cancel_dbConfig" value="{$mod_strings['LBL_CANCEL']}">
                </td></tr>
            </table>
