...
<table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
    ...
    {$mod_strings['LBL_PERFORM_TITLE']}<br>
    <a href="http://www.spicecrm.io" target="_blank">
    <IMG width="300" src="include/images/spice_big.png" alt="SpiceCRM" border="0"></a></th>
</tr>
<tr>
   <td>
EOQ;
    ...
    $fpResult =<<<FP
     ...
     <table cellspacing="0" cellpadding="0" border="0" class="stdTable">
       <tr>
         ...
         <td><input class="button paper-button-0 next" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="submit" name="goto" value="{$mod_strings['LBL_NEXT']}" id="button_next2"/></td>
       </tr>
     </table>
     </form>
FP;
       ...
       <tr>
         ...
         <td>
            <form action="index.php" method="post" name="formFinish" id="formFinish">
                ...
                <input class="button paper-button-0 next" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="submit" name="next" value="{$mod_strings['LBL_PERFORM_FINISH']}" id="button_next2"/>
            </form>
         </td>
       </tr>
     </table>
