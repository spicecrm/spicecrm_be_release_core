...
<table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
	...
	{$mod_strings['LBL_SYSOPTS_DB_TITLE']} <br>
		<a href="http://www.spicecrm.io" target="_blank"><IMG width="300" src="include/images/spice_big.png" alt="SpiceCRM" border="0"></a>
        </th>
</tr>
<tr>
   <td>
...
<hr>
     ...
     <table cellspacing="0" cellpadding="0" border="0" class="stdTable">
       <tr>
         <td>
            <input class="button paper-button-0" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="button" value="{$mod_strings['LBL_BACK']}" id="button_back_systemOptions" onclick="document.getElementById('form').submit();" />
            <input type="hidden" name="goto" value="{$mod_strings['LBL_BACK']}" />
         </td>
         <td><input class="button paper-button-0 next" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="submit" id="button_next2" name="goto" value="{$mod_strings['LBL_NEXT']}" /></td>
       </tr>
     </table>
</td>
</tr>
