 ...
 **/
//classic settings
$moduleList[] = 'CostCenters'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['CostCenters'] = 'CostCenter';
$beanFiles['CostCenter'] = 'modules/CostCenters/CostCenter.php';
