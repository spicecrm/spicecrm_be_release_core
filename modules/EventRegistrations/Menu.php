...
$module_menu = Array();
if($GLOBALS['ACLController']->checkAccess('EventRegistrations','edit',true)){
...
if($GLOBALS['ACLController']->checkAccess('EventRegistrations','list',true)){
...
if($GLOBALS['ACLController']->checkAccess('EventRegistrations','import',true)){
