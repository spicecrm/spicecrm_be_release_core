 ...
 **/
//classic settings
$moduleList[] = 'EventRegistrations'; //comment in case module shall not be display in module administration > display modules and subpanels
...
//$modInvisList[] = 'EventRegistrations';
//$report_include_modules['EventRegistrations'] = 'EventRegistration';
//$modules_exempt_from_availability_check['EventRegistrations']] = 'EventRegistration'];
//$adminOnlyList['EventRegistrations'] = array('all' => 1);
