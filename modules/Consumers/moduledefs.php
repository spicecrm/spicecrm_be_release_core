 ...
 **/             
//classic settings
$moduleList[] = 'Consumers'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['Consumers'] = 'Consumer';
$beanFiles['Consumer'] = 'modules/Consumers/Consumer.php';

//possible additional settings
//$modInvisList[] = 'Consumers';
//$report_include_modules['Consumers'] = 'Consumer';
//$modules_exempt_from_availability_check['Consumers']] = 'Consumers'];
//$adminOnlyList['Consumers'] = array('all' => 1);
