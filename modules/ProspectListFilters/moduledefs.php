 ...
 **/             
//classic settings
$moduleList[] = 'ProspectListFilters'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['ProspectListFilters'] = 'ProspectListFilter';
$beanFiles['ProspectListFilter'] = 'modules/ProspectListFilters/ProspectListFilter.php';

//possible additional settings
//$modInvisList[] = 'ProspectListFilters';
//$report_include_modules['ProspectListFilters'] = 'ProspectListFilter';
//$modules_exempt_from_availability_check['ProspectListFilters']] = 'ProspectListFilters'];
//$adminOnlyList['ProspectListFilters'] = array('all' => 1);
