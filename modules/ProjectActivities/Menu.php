...
$module_menu = Array();
if($GLOBALS['ACLController']->checkAccess('ProjectActivities','edit',true)){
...
if($GLOBALS['ACLController']->checkAccess('ProjectActivities','list',true)){
...
if($GLOBALS['ACLController']->checkAccess('ProjectActivities','import',true)){
