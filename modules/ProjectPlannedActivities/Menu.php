...
$module_menu = Array();
if($GLOBALS['ACLController']->checkAccess('ProjectPlannedActivities','edit',true)){
...
if($GLOBALS['ACLController']->checkAccess('ProjectPlannedActivities','list',true)){
...
if($GLOBALS['ACLController']->checkAccess('ProjectPlannedActivities','import',true)){
