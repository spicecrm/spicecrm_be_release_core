...
<script type="text/javascript" src="modules/Users/javascript/QuotaManager.js?{php}rand(100, 900){/php}"></script>
<div style="width: calc(100% - 5px); height: calc(100vh - 120px);" id="quotamanager"></div>