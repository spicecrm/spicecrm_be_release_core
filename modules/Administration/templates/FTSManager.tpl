...
<script type="text/javascript" src="modules/Administration/javascript/FTSManager.js?{php}rand(100, 900){/php}"></script>
<div style="width: calc(100% - 5px); height: calc(100vh - 120px);" id="languagemanager"></div>