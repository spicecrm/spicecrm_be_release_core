            ...
            foreach ($insert as $overview) {
                ...
                foreach ($this->overview->fieldDefs as $colDef) {
                    ...
                    if (isset($colDef['len']) && !empty($colDef['len']) &&
                        ...
                        $col_def_name = $colDef['name']; //PHP7 COMPAT
                        if (isset($overview->$col_def_name)) //PHP7 COMPAT
                        {
                            $overview->$col_def_name = substr($overview->$col_def_name, 0, $colDef['len']); //PHP7 COMPAT
                        }
                    }
                    ...
                    switch ($colDef['name']) {
                        ...
                        default:
                            $col_def_name = $colDef['name']; //PHP7 COMPAT
                            $overview->$col_def_name = SugarCleaner::cleanHtml(from_html($overview->$col_def_name)); //PHP7 COMPAT
                            $values .= $this->db->quoted($overview->$col_def_name); //PHP7 COMPAT
                            break;
                    }
                }
