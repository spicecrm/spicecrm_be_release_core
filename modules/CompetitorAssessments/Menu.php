...
$module_menu = Array();
if($GLOBALS['ACLController']->checkAccess('CompetitorAssessments','edit',true)){
...
if($GLOBALS['ACLController']->checkAccess('CompetitorAssessments','list',true)){
...
if($GLOBALS['ACLController']->checkAccess('CompetitorAssessments','import',true)){
