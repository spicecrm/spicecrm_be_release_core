...
if($GLOBALS['ACLController']->checkAccess('Campaigns', 'edit', true))
	$module_menu[] = array(
...
if($GLOBALS['ACLController']->checkAccess('Campaigns', 'list', true))
	$module_menu[]=	array(
...
if($GLOBALS['ACLController']->checkAccess('EmailTemplates', 'edit', true))
	$module_menu[] = array(
...
if($GLOBALS['ACLController']->checkAccess('EmailTemplates', 'list', true))
	$module_menu[] = array(
