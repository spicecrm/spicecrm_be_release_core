...
class MyProjectTaskDashlet extends DashletGeneric { 
    function __construct($id, $def = null) {
		...
		require('modules/ProjectTasks/Dashlets/MyProjectTaskDashlet/MyProjectTaskDashlet.data.php');
		
        parent::__construct($id, $def);
        
        if(empty($def['title'])) $this->title = translate('LBL_LIST_MY_PROJECT_TASKS', 'ProjectTasks');
