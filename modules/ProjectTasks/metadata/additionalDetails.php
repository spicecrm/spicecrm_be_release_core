...
function additionalDetailsProjectTask($fields) {
	...
	if(empty($mod_strings)) {
		...
		$mod_strings = return_module_language($current_language, 'ProjectTasks');
	}
	...
	return array('fieldToAddTo' => 'NAME', 
				 ...
				 'editLink' => "index.php?action=EditView&module=ProjectTasks&return_module=ProjectTasks&record={$fields['ID']}",
				 'viewLink' => "index.php?action=DetailView&module=ProjectTasks&return_module=ProjectTasks&record={$fields['ID']}");
}
