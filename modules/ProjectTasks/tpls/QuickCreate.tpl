...
<input type="hidden" name="module" value="ProjectTasks">
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<td align="left" style="padding-bottom: 2px;">
		...
		<input title="{$APP.LBL_FULL_FORM_BUTTON_TITLE}" accessKey="{$APP.LBL_FULL_FORM_BUTTON_KEY}" class="button" type="submit" name="button" onclick="this.form.to_pdf.value='0';this.form.action.value='EditView'; this.form.module.value='ProjectTasks';" value="  {$APP.LBL_FULL_FORM_BUTTON_LABEL}  "></td>
