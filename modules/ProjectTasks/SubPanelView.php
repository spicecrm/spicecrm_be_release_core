...
$project_module_strings = return_module_language($current_language, 'Projects');
...
$button .= "<input type='hidden' name='module' value='ProjectTasks' />\n";
...
$ListView->initNewXTemplate( 'modules/ProjectTasks/SubPanelView.html',$current_module_strings);
