...
if(ACLController::checkAccess('Project', 'edit', true))$module_menu[] = array("index.php?module=Projects&action=EditView&return_module=Projects&return_action=DetailView",
	$mod_strings['LNK_NEW_PROJECT'], 'CreateProject');
if(ACLController::checkAccess('Project', 'list', true))$module_menu[] = array('index.php?module=Projects&action=index',
