 ...
 **/
//classic settings
$moduleList[] = 'EmailSchedules'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['EmailSchedules'] = 'EmailSchedule';
$beanFiles['EmailSchedule'] = 'modules/EmailSchedules/EmailSchedule.php';
