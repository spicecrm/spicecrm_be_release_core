 ...
 **/             
//classic settings
$moduleList[] = 'SpiceImportTemplates'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['SpiceImportTemplates'] = 'SpiceImportTemplate';
$beanFiles['SpiceImportTemplate'] = 'modules/SpiceImportTemplates/SpiceImportTemplate.php';

//possible additional settings
//$modInvisList[] = 'SpiceImportTemplates';
//$report_include_modules['SpiceImportTemplates'] = 'SpiceImportTemplate';
//$modules_exempt_from_availability_check['SpiceImportTemplates']] = 'SpiceImportTemplates'];
//$adminOnlyList['SpiceImportTemplates'] = array('all' => 1);
