...
class KAuthProfilesViewManageKAuthObjectFields extends SugarView {
 	...
 	function display(){
		 ...
		 echo "<script type='text/javascript' src='modules/KAuthProfiles/javascript/manageKAuthObjectFields.js'>";
 	}	
}
?>