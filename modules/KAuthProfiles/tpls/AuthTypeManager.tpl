...
<script type="text/javascript" src="modules/KAuthProfiles/js/TAMAuthTypeManager.js?{php}rand(100, 900){/php}"></script>
<!--h1>Organization Management Core Configuration</h1><br-->
<div style="width: calc(100% - 5px); height: calc(100vh - 120px);" id="authtypemanager"></div>