 ...
 **/             
//classic settings
$moduleList[] = 'UserAbsences'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['UserAbsences'] = 'UserAbsence';
$beanFiles['UserAbsence'] = 'modules/UserAbsences/UserAbsence.php';

//possible additional settings
//$modInvisList[] = 'UserAbsences';
//$report_include_modules['UserAbsences'] = 'UserAbsence';
//$modules_exempt_from_availability_check['UserAbsences']] = 'UserAbsences'];
//$adminOnlyList['UserAbsences'] = array('all' => 1);
