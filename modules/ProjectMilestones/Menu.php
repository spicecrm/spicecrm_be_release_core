...
$module_menu = Array();
if($GLOBALS['ACLController']->checkAccess('ProjectMilestones','edit',true)){
...
if($GLOBALS['ACLController']->checkAccess('ProjectMilestones','list',true)){
...
if($GLOBALS['ACLController']->checkAccess('ProjectMilestones','import',true)){
