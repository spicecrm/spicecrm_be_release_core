 ...
 **/
//classic settings
$moduleList[] = 'Events'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['Events'] = 'Event';
$beanFiles['Event'] = 'modules/Events/Event.php';

//possible additional settings
//$modInvisList[] = 'Events';
//$report_include_modules['Events'] = 'Event';
//$modules_exempt_from_availability_check['Events']] = 'Event'];
//$adminOnlyList['Events'] = array('all' => 1);
