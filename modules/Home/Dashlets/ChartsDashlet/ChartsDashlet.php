...
class ChartsDashlet extends Dashlet {
     ...
     */
    function display() {
        //MARETVAL 2019-03-08: We are in CE version here! modules/Reports/Report.php does not exist!
        ...
        //We therefore return an error on screen to inform user
        if(!in_array($GLOBALS['sugar_flavor'], array('PRO', 'ENT'))){
            return parent::display()."<div align='center'>Dashlet generated by former Sugar PRO version. Related files do not exist anymore.<br/>
		        Remove dashlet and try to replace with a KReporter Dashlet. Contact your Reports administrator if you need a report.</div>" . "<br />"; // return parent::display for title and such
        }
        //END
...
//		ini_set('display_errors', 'false');
    ...
    function displayScript() {
        //BEGIN MARETVAL 2019-03-08: We are in CE version here! modules/Reports/Report.php does not exist!
        //Migrating from PRO to CE triggers following problem: Dashlets containg reports /charts based on PRO reports module cannot be displayed anymore
        //We therefore return empty string here
        if(!in_array($GLOBALS['sugar_flavor'], array('PRO', 'ENT'))){
            return '';
        }
        //END
