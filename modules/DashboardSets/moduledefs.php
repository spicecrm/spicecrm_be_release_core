 ...
 **/             
//classic settings
$moduleList[] = 'DashboardSets'; //comment in case module shall not be display in module administration > display modules and subpanels
$beanList['DashboardSets'] = 'DashboardSet';
$beanFiles['DashboardSet'] = 'modules/DashboardSets/DashboardSet.php';

//possible additional settings
//$modInvisList[] = 'DashboardSets';
//$report_include_modules['DashboardSets'] = 'DashboardSet';
//$modules_exempt_from_availability_check['DashboardSets']] = 'DashboardSets'];
//$adminOnlyList['DashboardSets'] = array('all' => 1);
