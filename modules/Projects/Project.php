...
class Project extends SugarBean {
    ...
    */
	...
	function build_generic_where_clause ($the_query_string)
	{
		...
		array_push($where_clauses, "projects.name LIKE '%$the_query_string%'");
	...
	function getAllProjectTasks(){
		...
		$query = "SELECT * FROM projecttasks WHERE project_id = '" . $this->id. "' AND deleted = 0 ORDER BY project_task_id";
