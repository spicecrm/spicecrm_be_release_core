...
$module_menu = Array();
if($GLOBALS['ACLController']->checkAccess('CompanyFiscalPeriods','edit',true)){
...
if($GLOBALS['ACLController']->checkAccess('CompanyFiscalPeriods','list',true)){
...
if($GLOBALS['ACLController']->checkAccess('CompanyFiscalPeriods','import',true)){
